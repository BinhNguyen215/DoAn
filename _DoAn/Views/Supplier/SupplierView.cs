...
namespace _DoAn.Views.Suplier
{
...

    {
        ...
        public string SuplierId { get => tbxID.Text; set => tbxID.Text = value; }
        public string SuplierName { get => tbxSuplierName.Text; set => tbxSuplierName.Text = value; }
        ...
        private void dtgvSupplier_DoubleClick(object sender, EventArgs e)
        {
            SupplierPresenter suplierPresenter = new SupplierPresenter(this);
        ...
        private void tbxSuplierName_TextChanged(object sender, EventArgs e)
        {
            SupplierPresenter suplierPresenter = new SupplierPresenter(this);
