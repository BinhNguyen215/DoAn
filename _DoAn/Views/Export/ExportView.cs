...
namespace _DoAn.Views.Export
{
    public partial class ExportView : Form, IExportView
    {
        ...
        public string Quantity { get => tbxQuantities.Text; set => tbxQuantities.Text = value; }
        public string message { get => _message; set => _message = value; }
        public string Search { get => tbxSearch.Text; set => tbxSearch.Text = value; }
        public string ExportReason { get => tbxReason.Text; set => tbxReason.Text = value; }
        ...
        string IExportView.ProductName { get => tbxProductName.Text; set => tbxProductName.Text = value; }
        string IExportView.Total { get => tbxTotalPrice.Text; set => tbxTotalPrice.Text = value; }
        ...
        {
            ExportPresenter exportPresenter = new ExportPresenter(this);
            if (System.Text.RegularExpressions.Regex.IsMatch(tbxQuantities.Text, "[^0-9]"))
            {
                MessageBox.Show("Please enter only numbers.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                tbxQuantities.Text = tbxQuantities.Text.Remove(tbxQuantities.Text.Length - 1);
            }
            else
